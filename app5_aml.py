                    ...
                    if generate_button:
                        if temp_file_path is not None:
                            ...
                            if st.session_state.llm == "Closed-Source":
                                ...
                                Cash Deposits or any other unusual transaction. Note: Do not include any Paycheck or salary deposits as they may not be considered as suspicious transactions.
                                Context: {context_1}\n\
