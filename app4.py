                    ...
                    if generate_button:
                        if temp_file_path is not None:
                            ...
                            if st.session_state.llm == "Closed-Source":
                                ...
                                response = usellm(prompt_1)
                                save_res = response
                                prompt_2 = f''' Your goal is to extract out the transactions of Debited($) amount less than $5000 from the input_data.Do not add any explanation or note in answer.\n\
