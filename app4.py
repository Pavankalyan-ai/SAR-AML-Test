                    ...
                    if generate_button:
                        if temp_file_path is not None:
                            ...
                            if st.session_state.llm == "Closed-Source":
                                ...
                                Consideration: Debited Transactions of amount less than $5000 amount that are uncommon and can be related to money laundering transactions. \n\n\
                                ...
                                Response: #strictly consider transactions with debited amount less than $5000'''
                                response_2 = usellm(prompt_2)
                                save_res2 = response_2
