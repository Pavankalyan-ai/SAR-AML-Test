                    ...
                    if generate_button:
                        if temp_file_path is not None:
                            ...
                            if st.session_state.llm == "Closed-Source":
                                ...
                                1.) Is There any high cash transactions happening of amount >= 5,000 USD value threshold.\n\n\
                                ...
                                3.) Are there any Payments made greater than or equal to $5000 to an unrecognized entity with no specific business purpose (Ex- Advisories, consultancies,etc.) \n\n\
                                4.) If there are Cash deposits greater than or equal to $5000 with source of funds not clear used to pay off credit card debt,\n\n\
