                    ...
                    if st.session_state.clicked1:
                        if temp_file_path2 is not None:
                            ...
                            if st.session_state.llm == "Closed-Source":
                                ...
                                Response: start the output answering if it can be considered as a suspicious activity or not based on the avaliable information?. If yes, then answer all the questions as individual points."""
                                system_prompt = wrap_prompt("You are a Money Laundering Analyst.", "system")
