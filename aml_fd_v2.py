                    ...
                    if st.session_state.clicked1:
                        if temp_file_path2 is not None:
                            ...
                            if st.session_state.llm == "Closed-Source":
                                ...
                                prompt_2 = f"""Add a concise introductory statement and Based on the given context, Give concise response to the each question below.\n\
                                ...
                                Context: {contexts}\n\
                                Response: (Give a neatly formatted response for each question individually. Also, give your recommendation for the below Question.# do not mention any words like Introduction, topics etc-) 
                                Question: {query} """
                                system_prompt = wrap_prompt("You are a Money Laundering Analyst.", "system")
