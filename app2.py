                    ...
                    if generate_button:
                        if temp_file_path is not None:
                            ...
                            if st.session_state.llm == "Closed-Source":
                                ...
                                1.) Debited transactions happening of amount > $5,000 value threshold.\n\n\
                                ...
                                Based on the above considerations , identify potential debited money laundering transcations.\n\n\
                                Also, Do include Card due payment Cleared transactions.\
                                
                                Question: {query}\n\
                                Context: {context_1}\n\
                                Response: (Give me a concise response as debited transactions only and IF transaction amount is less than $5000 , print them as additonal transactions.Do not give me any Explanation,Note, etc.)'''
                                response = usellm(prompt_1)
