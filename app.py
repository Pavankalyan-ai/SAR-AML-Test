                    ...
                    if st.button("Generate Insights",disabled=st.session_state.disabled):
                        if temp_file_path is not None:
                            ...
                            if st.session_state.llm == "Open-AI":
                                ...
                                This can be addresses as a suspicious activity based on [transaction amount (e.g. The Transcation amount is $5600.),suspect name not matching with the customer name, suspect address does not match with the customer address].\n\n\
