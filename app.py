                    ...
                    if st.button("Generate Insights",disabled=st.session_state.disabled):
                        if temp_file_path is not None:
                            ...
                            if st.session_state.llm == "Open-AI":
                                ...
                                prompt = f'''Act as a financial analyst and give concise answer to Question as truthfully as possible, with given Context. Give me a concise and relevant answer.\n\n\
                                            Question: {query}\n\
                                            Context: {context_1}\n\                      
                                            Response: '''
