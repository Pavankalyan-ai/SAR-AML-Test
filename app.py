                    ...
                    if st.button("Generate Insights",disabled=st.session_state.disabled):
                        if temp_file_path is not None:
                            ...
                            if st.session_state.llm == "Open-AI":
                                ...
                                prompt = f'''Act as a financial analyst and give concise answer to the question in bullets, with given Context.
                                This can be addresses as suspicious activity based on the transaction amount,type of fraud,suspect name not matching with the customer name.\n\n\
                                            Question: {query}\n\
                                            Context: {context_1}\n\                      
                                            Response: '''
